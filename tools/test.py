...
def main():
    ...
    # print(f"[DEBUG] data_loader 타입: {type(data_loader)}")
    # try:
    #     print(f"[DEBUG] data_loader 길이: {len(data_loader)}")
    # except Exception as e:
    #     print(f"[ERROR] data_loader 길이 확인 실패: {e}")
        
    # for i, data in enumerate(data_loader):
    #     img_meta_container = data['img_metas'][0]
    #     img_meta = img_meta_container.data[0]

    #     # [수정] list이면 첫 원소 꺼내기
    #     if isinstance(img_meta, list):
    #         img_meta = img_meta[0]

    #     print(f'[DEBUG] Loaded sample {i}:', img_meta['filename'])
    #     if i == 5:
    #         break
