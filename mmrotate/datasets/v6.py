...
class V6Dataset(CustomDataset):
    ...
    CLASSES = ('ship(S)', 'ship(L)', 'aircraft', 'large-vehicle', 'small-vehicle',
               'crane', 'bridge', 'storage-tank', 'dam', 'stadium', 'sports-field',
    ...
    def __init__(self,
        ...
        super(V6Dataset, self).__init__(ann_file, pipeline, **kwargs)
